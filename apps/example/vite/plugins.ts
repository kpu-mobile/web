...
import { AutoImports as KpuMobileAutoImports, ComponentsResolver as KpuMobileComponentsResolver, ComponentsType as KpuMobileComponentsType } from '@kpu-mobile/components/resolver'
import { createCopyrightPlugins as createKpuMobileCopyrightPlugins } from '@kpu-mobile/copyright'
...
export default function createVitePlugins(mode: string, isBuild = false) {
  ...
  const vitePlugins: (PluginOption | PluginOption[])[] = [
    ...
    components({
      ...
      resolvers: [
        KpuMobileComponentsResolver(),
      ],
      types: [
        KpuMobileComponentsType,
      ],
    }),
    ...
    TurboConsole(),
    createKpuMobileCopyrightPlugins(),
