...
const data: {
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/feature/function/hapticFeedback',
        title: $t('pages.function.hapticFeedback'),
        icon: 'i-material-symbols:touch-app-outline',
        pro: true,
      },
      {
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/feature/component/built_in/button_group/',
        title: '按钮组',
      },
      {
...
<template>
  <AppPageLayout :navbar="false" saved-position tabbar>
    <div class="p-4">
