...
阅读开发文档前，请确保手上已经有 Kpu-mobile 源码，因为文档中提及的内容，都是需要在本地项目中编写或修改代码并运行才能呈现的。

### 基础版

到 [Github Releases](https://github.com/kpu-mobile/web/releases) 页面下载最新版本的压缩包，如下图所示：
...
```sh
# 从 Github 拉取
git clone https://github.com/kpu-mobile/web.git
# 从 Gitee 拉取
git clone https://gitee.com/kpu-mobile/web.git
```
