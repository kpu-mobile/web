...
<template>
  <KmPageLayout navbar navbar-start-side="back">
    <div class="flex flex-col gap-4 p-4">
      ...
      <KmPageMain title="Button" class="m-0">
      ...
      <KmPageMain title="Rate" class="m-0">
        <van-rate v-model="rate" />
      </KmPageMain>
      <KmPageMain title="Switch" class="m-0">
