  ...
  <KmPageLayout navbar navbar-start-side="back">
    <div class="flex flex-col gap-4 p-4">
      ...
      <KmPageMain v-if="settingsStore.settings.app.enablePermission" title="鉴权函数" class="m-0" main-class="flex flex-col gap-2">
        ...
        <KmButton variant="outline" @click="permissionCheck('permission.create')">
          校验 create 权限
        </KmButton>
        <KmButton variant="outline" @click="permissionCheck(['permission.browse', 'permission.create'])">
          校验 browse 或 create 权限
        </KmButton>
        <KmButton variant="outline" @click="permissionCheck2(['permission.browse', 'permission.create'])">
