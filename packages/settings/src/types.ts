import type { BASE_COLORS, THEMES } from '@kpu-mobile/themes'
...
export interface ThemeSettings {
  ...
  /**
   * 亮色基础色
   * @description指定亮色模式下的基础色
   * @default 'neutral'
   */
  baseColorLight?: keyof typeof BASE_COLORS
  /**
   * 暗色基础色
   * @description 指定暗色模式下的基础色
   * @default 'neutral'
   */
  baseColorDark?: keyof typeof BASE_COLORS
  /**
   * 亮色主题
