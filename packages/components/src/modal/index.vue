  ...
  <Dialog :open="isOpen" @update:open="updateOpen">
    ...
    >
      ...
      <div v-show="props.loading" class="bg-popover/75 flex-center size-full inset-0 absolute z-1000">
        <KmIcon name="i-line-md:loading-twotone-loop" class="size-10" />
      </div>
      <DialogFooter
      ...
      >
        <slot name="footer">
          ...
          <KmButton v-if="showConfirmButton" :disabled="confirmButtonDisabled" :loading="confirmButtonLoading || isConfirmButtonLoading" @click="onConfirm">
