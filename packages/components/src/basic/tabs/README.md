...
<template>
  <KmTabs v-model="activeTab" :list @update:model-value="handleTabChange">
...
<template>
  <KmTabs v-model="activeTab" :list>
    ...
    <template #security>
      <form class="space-y-4">
        <KmInput label="当前密码" type="password" />
        <KmInput label="新密码" type="password" />
      </form>
    </template>
    <template #preference>
      <div class="space-y-4">
